...
62565 gosub 62280
62570 gosub 42000:get a$:if a$=" " or a$=chr$(13) then 62580
62572 rn=rnd(1):if rn>0.99 then gosub 39400:goto 62570
62574 if rn>0.98 then gosub 39750:goto 62570
62576 if rn>0.97 then gosub 39650
62578 goto 62570
...
62810 if a$=chr$(133) then af%(0)=(af%(0)+1) and 1
62820 if a$=chr$(134) then af%(1)=(af%(1)+1) and 1
